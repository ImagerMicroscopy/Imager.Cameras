...
public:
    ...
    PCOAPIWrapper(const std::string& libraryPath) : _allFunctionsLoaded(true) {
        ...
        functionMap = {
            ...
            {"PCO_GetTemperature", &_PCO_GetTemperature},
            {"PCO_GetInfoString", &_PCO_GetInfoString},
            {"PCO_GetCameraName", &_PCO_GetCameraName},
            {"PCO_GetFirmwareInfo", &_PCO_GetFirmwareInfo},
            {"PCO_GetCameraSetup", &_PCO_GetCameraSetup},
            {"PCO_SetCameraSetup", &_PCO_SetCameraSetup},
            {"PCO_RebootCamera", &_PCO_RebootCamera},
            {"PCO_GetShutterMode", &_PCO_GetShutterMode},
            ...
            {"PCO_GetCameraDescriptionEx", &_PCO_GetCameraDescriptionEx},
            {"PCO_GetSensorFormat", &_PCO_GetSensorFormat},
            {"PCO_SetSensorFormat", &_PCO_SetSensorFormat},
            {"PCO_GetSizes", &_PCO_GetSizes},
            {"PCO_GetROI", &_PCO_GetROI},
            {"PCO_SetROI", &_PCO_SetROI},
            {"PCO_GetBinning", &_PCO_GetBinning},
            {"PCO_SetBinning", &_PCO_SetBinning},
            {"PCO_GetPixelRate", &_PCO_GetPixelRate},
            {"PCO_SetPixelRate", &_PCO_SetPixelRate},
            {"PCO_GetConversionFactor", &_PCO_GetConversionFactor},
            {"PCO_SetConversionFactor", &_PCO_SetConversionFactor},
            {"PCO_GetDoubleImageMode", &_PCO_GetDoubleImageMode},
            {"PCO_SetDoubleImageMode", &_PCO_SetDoubleImageMode},
            {"PCO_GetADCOperation", &_PCO_GetADCOperation},
            {"PCO_SetADCOperation", &_PCO_SetADCOperation},
            {"PCO_GetIRSensitivity", &_PCO_GetIRSensitivity},
            {"PCO_SetIRSensitivity", &_PCO_SetIRSensitivity},
            {"PCO_GetCoolingSetpoints", &_PCO_GetCoolingSetpoints},
            {"PCO_GetCoolingSetpointTemperature", &_PCO_GetCoolingSetpointTemperature},
            {"PCO_SetCoolingSetpointTemperature", &_PCO_SetCoolingSetpointTemperature},
            {"PCO_GetOffsetMode", &_PCO_GetOffsetMode},
            {"PCO_SetOffsetMode", &_PCO_SetOffsetMode},
            {"PCO_GetNoiseFilterMode", &_PCO_GetNoiseFilterMode},
            {"PCO_SetNoiseFilterMode", &_PCO_SetNoiseFilterMode},
            {"PCO_GetHWIOSignalCount", &_PCO_GetHWIOSignalCount},
            {"PCO_GetHWIOSignalDescriptor", &_PCO_GetHWIOSignalDescriptor},
            {"PCO_GetColorCorrectionMatrix", &_PCO_GetColorCorrectionMatrix},
            {"PCO_GetDSNUAdjustMode", &_PCO_GetDSNUAdjustMode},
            {"PCO_SetDSNUAdjustMode", &_PCO_SetDSNUAdjustMode},
            {"PCO_InitDSNUAdjustment", &_PCO_InitDSNUAdjustment},
            {"PCO_GetCDIMode", &_PCO_GetCDIMode},
            {"PCO_SetCDIMode", &_PCO_SetCDIMode},
            {"PCO_GetLookupTableInfo", &_PCO_GetLookupTableInfo},
            {"PCO_GetActiveLookupTable", &_PCO_GetActiveLookupTable},
            {"PCO_SetActiveLookupTable", &_PCO_SetActiveLookupTable},
            {"PCO_GetIntensifiedGatingMode", &_PCO_GetIntensifiedGatingMode},
            {"PCO_SetIntensifiedGatingMode", &_PCO_SetIntensifiedGatingMode},
            {"PCO_GetIntensifiedMCP", &_PCO_GetIntensifiedMCP},
            {"PCO_SetIntensifiedMCP", &_PCO_SetIntensifiedMCP},
            {"PCO_GetSensorDarkOffset", &_PCO_GetSensorDarkOffset},
            {"PCO_GetTimingStruct", &_PCO_GetTimingStruct},
            {"PCO_SetTimingStruct", &_PCO_SetTimingStruct},
            {"PCO_GetDelayExposureTime", &_PCO_GetDelayExposureTime},
            {"PCO_SetDelayExposureTime", &_PCO_SetDelayExposureTime},
            {"PCO_GetDelayExposureTimeTable", &_PCO_GetDelayExposureTimeTable},
            {"PCO_SetDelayExposureTimeTable", &_PCO_SetDelayExposureTimeTable},
            {"PCO_GetTriggerMode", &_PCO_GetTriggerMode},
            {"PCO_SetTriggerMode", &_PCO_SetTriggerMode},
            {"PCO_ForceTrigger", &_PCO_ForceTrigger},
            {"PCO_GetCameraBusyStatus", &_PCO_GetCameraBusyStatus},
            {"PCO_GetPowerDownMode", &_PCO_GetPowerDownMode},
            {"PCO_SetPowerDownMode", &_PCO_SetPowerDownMode},
            {"PCO_GetUserPowerDownTime", &_PCO_GetUserPowerDownTime},
            {"PCO_SetUserPowerDownTime", &_PCO_SetUserPowerDownTime},
            {"PCO_GetExpTrigSignalStatus", &_PCO_GetExpTrigSignalStatus},
            {"PCO_GetCOCRuntime", &_PCO_GetCOCRuntime},
            {"PCO_GetFPSExposureMode", &_PCO_GetFPSExposureMode},
            {"PCO_SetFPSExposureMode", &_PCO_SetFPSExposureMode},
            {"PCO_GetModulationMode", &_PCO_GetModulationMode},
            {"PCO_SetModulationMode", &_PCO_SetModulationMode},
            {"PCO_GetFrameRate", &_PCO_GetFrameRate},
            {"PCO_SetFrameRate", &_PCO_SetFrameRate},
            {"PCO_GetStorageStruct", &_PCO_GetStorageStruct},
            {"PCO_SetStorageStruct", &_PCO_SetStorageStruct},
            {"PCO_GetCameraRamSize", &_PCO_GetCameraRamSize},
            {"PCO_GetCameraRamSegmentSize", &_PCO_GetCameraRamSegmentSize},
            {"PCO_SetCameraRamSegmentSize", &_PCO_SetCameraRamSegmentSize},
            {"PCO_ClearRamSegment", &_PCO_ClearRamSegment},
            {"PCO_GetActiveRamSegment", &_PCO_GetActiveRamSegment},
            {"PCO_SetActiveRamSegment", &_PCO_SetActiveRamSegment},
            {"PCO_GetCompressionMode", &_PCO_GetCompressionMode},
            {"PCO_SetCompressionMode", &_PCO_SetCompressionMode},
            {"PCO_GetMaxNumberOfImagesInSegment", &_PCO_GetMaxNumberOfImagesInSegment},
            {"PCO_GetRecordingStruct", &_PCO_GetRecordingStruct},
            {"PCO_SetRecordingStruct", &_PCO_SetRecordingStruct},
            {"PCO_GetStorageMode", &_PCO_GetStorageMode},
            {"PCO_SetStorageMode", &_PCO_SetStorageMode},
            {"PCO_GetRecorderSubmode", &_PCO_GetRecorderSubmode},
            {"PCO_SetRecorderSubmode", &_PCO_SetRecorderSubmode},
            {"PCO_GetRecordingState", &_PCO_GetRecordingState},
            {"PCO_SetRecordingState", &_PCO_SetRecordingState},
            {"PCO_ArmCamera", &_PCO_ArmCamera},
            {"PCO_GetAcquireMode", &_PCO_GetAcquireMode},
            {"PCO_SetAcquireMode", &_PCO_SetAcquireMode},
            {"PCO_GetAcquireModeEx", &_PCO_GetAcquireModeEx},
            {"PCO_SetAcquireModeEx", &_PCO_SetAcquireModeEx},
            {"PCO_GetAcquireControl", &_PCO_GetAcquireControl},
            {"PCO_SetAcquireControl", &_PCO_SetAcquireControl},
            {"PCO_GetAcqEnblSignalStatus", &_PCO_GetAcqEnblSignalStatus},
            {"PCO_SetDateTime", &_PCO_SetDateTime},
            {"PCO_GetTimestampMode", &_PCO_GetTimestampMode},
            {"PCO_SetTimestampMode", &_PCO_SetTimestampMode},
            {"PCO_GetRecordStopEvent", &_PCO_GetRecordStopEvent},
            {"PCO_SetRecordStopEvent", &_PCO_SetRecordStopEvent},
            {"PCO_StopRecord", &_PCO_StopRecord},
            {"PCO_GetImage", &_PCO_GetImage},
            {"PCO_GetImageEx", &_PCO_GetImageEx},
            {"PCO_GetPendingBuffer", &_PCO_GetPendingBuffer},
            {"PCO_CheckDeviceAvailability", &_PCO_CheckDeviceAvailability},
            {"PCO_SetTransferParameter", &_PCO_SetTransferParameter},
            {"PCO_GetTransferParameter", &_PCO_GetTransferParameter},
            {"PCO_SetTransferParametersAuto", &_PCO_SetTransferParametersAuto},
            {"PCO_CamLinkSetImageParameters", &_PCO_CamLinkSetImageParameters},
            {"PCO_SetImageParameters", &_PCO_SetImageParameters},
            {"PCO_SetTimeouts", &_PCO_SetTimeouts},
            {"PCO_GetImageTransferMode", &_PCO_GetImageTransferMode},
            {"PCO_SetImageTransferMode", &_PCO_SetImageTransferMode},
            {"PCO_AddBufferExtern", &_PCO_AddBufferExtern},
            {"PCO_GetMetaData", &_PCO_GetMetaData},
            {"PCO_GetMetaDataExtern", &_PCO_GetMetaDataExtern},
            {"PCO_GetTimeStamp", &_PCO_GetTimeStamp},
            {"PCO_GetDeviceStatus", &_PCO_GetDeviceStatus},
            {"PCO_ControlCommandCall", &_PCO_ControlCommandCall},
            {"PCO_ResetLib", &_PCO_ResetLib},
            {"PCO_InitializeLib", &_PCO_InitializeLib},
            {"PCO_CleanupLib", &_PCO_CleanupLib},
            {"PCO_EnableSoftROI", &_PCO_EnableSoftROI},
            {"PCO_GetAPIManagement", &_PCO_GetAPIManagement},
            {"PCO_GetErrorTextSDK", &_PCO_GetErrorTextSDK},
            {"PCO_GetVersionInfoSC2_Cam", &_PCO_GetVersionInfoSC2_Cam},
    ...
    int PCO_GetTemperature(HANDLE ph, SHORT* sCCDTemp, SHORT* sCamTemp, SHORT* sPowTemp) {
        ...
        return reinterpret_cast<PCO_GetTemperature_func>(_PCO_GetTemperature)(ph, sCCDTemp, sCamTemp, sPowTemp);
    }
    ...
    int PCO_GetInfoString(HANDLE ph, DWORD dwinfotype, char* buf_in, WORD size_in) {
        ...
        return reinterpret_cast<PCO_GetInfoString_func>(_PCO_GetInfoString)(ph, dwinfotype, buf_in, size_in);
    }
    ...
    int PCO_GetFirmwareInfo(HANDLE ph, WORD wDeviceBlock, void* pstrFirmWareVersion) {
        ...
        return reinterpret_cast<PCO_GetFirmwareInfo_func>(_PCO_GetFirmwareInfo)(ph, wDeviceBlock, pstrFirmWareVersion);
    }
    ...
    int PCO_GetCameraSetup(HANDLE ph, WORD* wType, DWORD* dwSetup, WORD* wLen) {
        ...
        return reinterpret_cast<PCO_GetCameraSetup_func>(_PCO_GetCameraSetup)(ph, wType, dwSetup, wLen);
    }
    ...
    int PCO_SetCameraSetup(HANDLE ph, WORD wType, DWORD* dwSetup, WORD wLen) {
        ...
        return reinterpret_cast<PCO_SetCameraSetup_func>(_PCO_SetCameraSetup)(ph, wType, dwSetup, wLen);
    }
    ...
    int PCO_RebootCamera(HANDLE ph) {
        ...
        return reinterpret_cast<PCO_RebootCamera_func>(_PCO_RebootCamera)(ph);
    }
    ...
    int PCO_GetShutterMode(HANDLE ph, WORD* wShuttermode) {
        ...
        return reinterpret_cast<PCO_GetShutterMode_func>(_PCO_GetShutterMode)(ph, wShuttermode);
    }
    ...
    int PCO_SetShutterMode(HANDLE ph, WORD wShuttermode) {
        ...
        return reinterpret_cast<PCO_SetShutterMode_func>(_PCO_SetShutterMode)(ph, wShuttermode);
    }
    ...
    int PCO_GetPowerSaveMode(HANDLE ph, WORD* wMode, WORD* wDelayMinutes) {
        ...
        return reinterpret_cast<PCO_GetPowerSaveMode_func>(_PCO_GetPowerSaveMode)(ph, wMode, wDelayMinutes);
    }
    ...
    int PCO_GetSensorStruct(HANDLE ph, void* strSensor) {
        ...
        return reinterpret_cast<PCO_GetSensorStruct_func>(_PCO_GetSensorStruct)(ph, strSensor);
    }
    ...
    int PCO_SetSensorStruct(HANDLE ph, void* strSensor) {
        ...
        return reinterpret_cast<PCO_SetSensorStruct_func>(_PCO_SetSensorStruct)(ph, strSensor);
    }
    ...
    int PCO_GetCameraDescriptionEx(HANDLE ph, void* strDescription, WORD wType) {
        ...
        return reinterpret_cast<PCO_GetCameraDescriptionEx_func>(_PCO_GetCameraDescriptionEx)(ph, strDescription, wType);
    }
    ...
    int PCO_GetSensorFormat(HANDLE ph, WORD* wSensor) {
        ...
        return reinterpret_cast<PCO_GetSensorFormat_func>(_PCO_GetSensorFormat)(ph, wSensor);
    }
    ...
    int PCO_SetSensorFormat(HANDLE ph, WORD wSensor) {
        ...
        return reinterpret_cast<PCO_SetSensorFormat_func>(_PCO_SetSensorFormat)(ph, wSensor);
    }
    ...
    int PCO_GetROI(HANDLE ph, WORD* wRoiX0, WORD* wRoiY0, WORD* wRoiX1, WORD* wRoiY1) {
        ...
        return reinterpret_cast<PCO_GetROI_func>(_PCO_GetROI)(ph, wRoiX0, wRoiY0, wRoiX1, wRoiY1);
    }
    ...
    int PCO_SetROI(HANDLE ph, WORD wRoiX0, WORD wRoiY0, WORD wRoiX1, WORD wRoiY1) {
        ...
        return reinterpret_cast<PCO_SetROI_func>(_PCO_SetROI)(ph, wRoiX0, wRoiY0, wRoiX1, wRoiY1);
    }
    ...
    int PCO_GetBinning(HANDLE ph, WORD* wBinHorz, WORD* wBinVert) {
        ...
        return reinterpret_cast<PCO_GetBinning_func>(_PCO_GetBinning)(ph, wBinHorz, wBinVert);
    }
    ...
    int PCO_SetBinning(HANDLE ph, WORD wBinHorz, WORD wBinVert) {
        ...
        return reinterpret_cast<PCO_SetBinning_func>(_PCO_SetBinning)(ph, wBinHorz, wBinVert);
    }
    ...
    int PCO_GetConversionFactor(HANDLE ph, WORD* wConvFact) {
        ...
        return reinterpret_cast<PCO_GetConversionFactor_func>(_PCO_GetConversionFactor)(ph, wConvFact);
    }
    ...
    int PCO_SetConversionFactor(HANDLE ph, WORD wConvFact) {
        ...
        return reinterpret_cast<PCO_SetConversionFactor_func>(_PCO_SetConversionFactor)(ph, wConvFact);
    }
    ...
    int PCO_GetDoubleImageMode(HANDLE ph, WORD* wDoubleImage) {
        ...
        return reinterpret_cast<PCO_GetDoubleImageMode_func>(_PCO_GetDoubleImageMode)(ph, wDoubleImage);
    }
    ...
    int PCO_SetDoubleImageMode(HANDLE ph, WORD wDoubleImage) {
        ...
        return reinterpret_cast<PCO_SetDoubleImageMode_func>(_PCO_SetDoubleImageMode)(ph, wDoubleImage);
    }
    ...
    int PCO_GetADCOperation(HANDLE ph, WORD* wADCOperation) {
        ...
        return reinterpret_cast<PCO_GetADCOperation_func>(_PCO_GetADCOperation)(ph, wADCOperation);
    }
    ...
    int PCO_SetADCOperation(HANDLE ph, WORD wADCOperation) {
        ...
        return reinterpret_cast<PCO_SetADCOperation_func>(_PCO_SetADCOperation)(ph, wADCOperation);
    }
    ...
    int PCO_GetIRSensitivity(HANDLE ph, WORD* wIR) {
        ...
        return reinterpret_cast<PCO_GetIRSensitivity_func>(_PCO_GetIRSensitivity)(ph, wIR);
    }
    ...
    int PCO_SetIRSensitivity(HANDLE ph, WORD wIR) {
        ...
        return reinterpret_cast<PCO_SetIRSensitivity_func>(_PCO_SetIRSensitivity)(ph, wIR);
    }
    ...
    int PCO_GetCoolingSetpoints(HANDLE ph, WORD wBlockID, WORD* wNumSetPoints, SHORT* sCoolSetpoints) {
        ...
        return reinterpret_cast<PCO_GetCoolingSetpoints_func>(_PCO_GetCoolingSetpoints)(ph, wBlockID, wNumSetPoints, sCoolSetpoints);
    }
    ...
    int PCO_GetCoolingSetpointTemperature(HANDLE ph, SHORT* sCoolSet) {
        ...
        return reinterpret_cast<PCO_GetCoolingSetpointTemperature_func>(_PCO_GetCoolingSetpointTemperature)(ph, sCoolSet);
    }
    ...
    int PCO_SetCoolingSetpointTemperature(HANDLE ph, SHORT sCoolSet) {
        ...
        return reinterpret_cast<PCO_SetCoolingSetpointTemperature_func>(_PCO_SetCoolingSetpointTemperature)(ph, sCoolSet);
    }
    ...
    int PCO_GetOffsetMode(HANDLE ph, WORD* wOffsetRegulation) {
        ...
        return reinterpret_cast<PCO_GetOffsetMode_func>(_PCO_GetOffsetMode)(ph, wOffsetRegulation);
    }
    ...
    int PCO_SetOffsetMode(HANDLE ph, WORD wOffsetRegulation) {
        ...
        return reinterpret_cast<PCO_SetOffsetMode_func>(_PCO_SetOffsetMode)(ph, wOffsetRegulation);
    }
    ...
    int PCO_GetNoiseFilterMode(HANDLE ph, WORD* wNoiseFilterMode) {
        ...
        return reinterpret_cast<PCO_GetNoiseFilterMode_func>(_PCO_GetNoiseFilterMode)(ph, wNoiseFilterMode);
    }
    ...
    int PCO_SetNoiseFilterMode(HANDLE ph, WORD wNoiseFilterMode) {
        ...
        return reinterpret_cast<PCO_SetNoiseFilterMode_func>(_PCO_SetNoiseFilterMode)(ph, wNoiseFilterMode);
    }
    ...
    int PCO_GetHWIOSignalCount(HANDLE ph, WORD* wNumSignals) {
        ...
        return reinterpret_cast<PCO_GetHWIOSignalCount_func>(_PCO_GetHWIOSignalCount)(ph, wNumSignals);
    }
    ...
    int PCO_GetHWIOSignalDescriptor(HANDLE ph, WORD wSignalNum, void* pstrSignal) {
        ...
        return reinterpret_cast<PCO_GetHWIOSignalDescriptor_func>(_PCO_GetHWIOSignalDescriptor)(ph, wSignalNum, pstrSignal);
    }
    ...
    int PCO_GetColorCorrectionMatrix(HANDLE ph, double* pdMatrix) {
        ...
        return reinterpret_cast<PCO_GetColorCorrectionMatrix_func>(_PCO_GetColorCorrectionMatrix)(ph, pdMatrix);
    }
    ...
    int PCO_GetDSNUAdjustMode(HANDLE ph, WORD* wDSNUAdjustMode, WORD* wReserved) {
        ...
        return reinterpret_cast<PCO_GetDSNUAdjustMode_func>(_PCO_GetDSNUAdjustMode)(ph, wDSNUAdjustMode, wReserved);
    }
    ...
    int PCO_SetDSNUAdjustMode(HANDLE ph, WORD wDSNUAdjustMode, WORD wReserved) {
        ...
        return reinterpret_cast<PCO_SetDSNUAdjustMode_func>(_PCO_SetDSNUAdjustMode)(ph, wDSNUAdjustMode, wReserved);
    }
    ...
    int PCO_InitDSNUAdjustment(HANDLE ph, WORD wDSNUAdjustMode, WORD wReserved) {
        ...
        return reinterpret_cast<PCO_InitDSNUAdjustment_func>(_PCO_InitDSNUAdjustment)(ph, wDSNUAdjustMode, wReserved);
    }
    ...
    int PCO_GetCDIMode(HANDLE ph, WORD* wCDIMode) {
        ...
        return reinterpret_cast<PCO_GetCDIMode_func>(_PCO_GetCDIMode)(ph, wCDIMode);
    }
    ...
    int PCO_SetCDIMode(HANDLE ph, WORD wCDIMode) {
        ...
        return reinterpret_cast<PCO_SetCDIMode_func>(_PCO_SetCDIMode)(ph, wCDIMode);
    }
    ...
    int PCO_GetLookupTableInfo(HANDLE ph, WORD wLUTNum, WORD* wNumberOfLuts, char* Description, WORD wDescLen, WORD* wIdentifier, BYTE* bInputWidth, BYTE* bOutputWidth, WORD* wFormat) {
        ...
        return reinterpret_cast<PCO_GetLookupTableInfo_func>(_PCO_GetLookupTableInfo)(ph, wLUTNum, wNumberOfLuts, Description, wDescLen, wIdentifier, bInputWidth, bOutputWidth, wFormat);
    }
    ...
    int PCO_GetActiveLookupTable(HANDLE ph, WORD* wIdentifier, WORD* wParameter) {
        ...
        return reinterpret_cast<PCO_GetActiveLookupTable_func>(_PCO_GetActiveLookupTable)(ph, wIdentifier, wParameter);
    }
    ...
    int PCO_SetActiveLookupTable(HANDLE ph, WORD* wIdentifier, WORD* wParameter) {
        ...
        return reinterpret_cast<PCO_SetActiveLookupTable_func>(_PCO_SetActiveLookupTable)(ph, wIdentifier, wParameter);
    }
    ...
    int PCO_GetIntensifiedGatingMode(HANDLE ph, WORD* wIntensifiedGatingMode, WORD* wReserved) {
        ...
        return reinterpret_cast<PCO_GetIntensifiedGatingMode_func>(_PCO_GetIntensifiedGatingMode)(ph, wIntensifiedGatingMode, wReserved);
    }
    ...
    int PCO_SetIntensifiedGatingMode(HANDLE ph, WORD wIntensifiedGatingMode, WORD wReserved) {
        ...
        return reinterpret_cast<PCO_SetIntensifiedGatingMode_func>(_PCO_SetIntensifiedGatingMode)(ph, wIntensifiedGatingMode, wReserved);
    }
    ...
    int PCO_GetIntensifiedMCP(HANDLE ph, WORD* wIntensifiedVoltage, WORD* wReserved, DWORD* dwIntensifiedPhosphorDecay_us, DWORD* dwReserved1, DWORD* dwReserved2) {
        ...
        return reinterpret_cast<PCO_GetIntensifiedMCP_func>(_PCO_GetIntensifiedMCP)(ph, wIntensifiedVoltage, wReserved, dwIntensifiedPhosphorDecay_us, dwReserved1, dwReserved2);
    }
    ...
    int PCO_SetIntensifiedMCP(HANDLE ph, WORD wIntensifiedVoltage, WORD wFlags, WORD wReserved, DWORD dwIntensifiedPhosphorDecay_us, DWORD dwReserved1, DWORD dwReserved2) {
        ...
        return reinterpret_cast<PCO_SetIntensifiedMCP_func>(_PCO_SetIntensifiedMCP)(ph, wIntensifiedVoltage, wFlags, wReserved, dwIntensifiedPhosphorDecay_us, dwReserved1, dwReserved2);
    }
    ...
    int PCO_GetSensorDarkOffset(HANDLE ph, WORD* pwDarkOffset) {
        ...
        return reinterpret_cast<PCO_GetSensorDarkOffset_func>(_PCO_GetSensorDarkOffset)(ph, pwDarkOffset);
    }
    ...
    int PCO_GetTimingStruct(HANDLE ph, void* strTiming) {
        ...
        return reinterpret_cast<PCO_GetTimingStruct_func>(_PCO_GetTimingStruct)(ph, strTiming);
    }
    ...
    int PCO_SetTimingStruct(HANDLE ph, void* strTiming) {
        ...
        return reinterpret_cast<PCO_SetTimingStruct_func>(_PCO_SetTimingStruct)(ph, strTiming);
    }
    ...
    int PCO_GetDelayExposureTimeTable(HANDLE ph, DWORD* dwDelay, DWORD* dwExposure, WORD* wTimeBaseDelay, WORD* wTimeBaseExposure, WORD wCount) {
        ...
        return reinterpret_cast<PCO_GetDelayExposureTimeTable_func>(_PCO_GetDelayExposureTimeTable)(ph, dwDelay, dwExposure, wTimeBaseDelay, wTimeBaseExposure, wCount);
    }
    ...
    int PCO_SetDelayExposureTimeTable(HANDLE ph, DWORD* dwDelay, DWORD* dwExposure, WORD wTimeBaseDelay, WORD wTimeBaseExposure, WORD wCount) {
        ...
        return reinterpret_cast<PCO_SetDelayExposureTimeTable_func>(_PCO_SetDelayExposureTimeTable)(ph, dwDelay, dwExposure, wTimeBaseDelay, wTimeBaseExposure, wCount);
    }
    ...
    int PCO_GetTriggerMode(HANDLE ph, WORD* wTriggerMode) {
        ...
        return reinterpret_cast<PCO_GetTriggerMode_func>(_PCO_GetTriggerMode)(ph, wTriggerMode);
    }
    ...
    int PCO_SetTriggerMode(HANDLE ph, WORD wTriggerMode) {
        ...
        return reinterpret_cast<PCO_SetTriggerMode_func>(_PCO_SetTriggerMode)(ph, wTriggerMode);
    }
    ...
    int PCO_ForceTrigger(HANDLE ph, WORD* wTriggered) {
        ...
        return reinterpret_cast<PCO_ForceTrigger_func>(_PCO_ForceTrigger)(ph, wTriggered);
    }
    ...
    int PCO_GetCameraBusyStatus(HANDLE ph, WORD* wCameraBusyState) {
        ...
        return reinterpret_cast<PCO_GetCameraBusyStatus_func>(_PCO_GetCameraBusyStatus)(ph, wCameraBusyState);
    }
    ...
    int PCO_GetPowerDownMode(HANDLE ph, WORD* wPowerDownMode) {
        ...
        return reinterpret_cast<PCO_GetPowerDownMode_func>(_PCO_GetPowerDownMode)(ph, wPowerDownMode);
    }
    ...
    int PCO_SetPowerDownMode(HANDLE ph, WORD wPowerDownMode) {
        ...
        return reinterpret_cast<PCO_SetPowerDownMode_func>(_PCO_SetPowerDownMode)(ph, wPowerDownMode);
    }
    ...
    int PCO_GetUserPowerDownTime(HANDLE ph, DWORD* dwPowerDownTime) {
        ...
        return reinterpret_cast<PCO_GetUserPowerDownTime_func>(_PCO_GetUserPowerDownTime)(ph, dwPowerDownTime);
    }
    ...
    int PCO_SetUserPowerDownTime(HANDLE ph, DWORD dwPowerDownTime) {
        ...
        return reinterpret_cast<PCO_SetUserPowerDownTime_func>(_PCO_SetUserPowerDownTime)(ph, dwPowerDownTime);
    }
    ...
    int PCO_GetExpTrigSignalStatus(HANDLE ph, WORD* wExpTrgSignal) {
        ...
        return reinterpret_cast<PCO_GetExpTrigSignalStatus_func>(_PCO_GetExpTrigSignalStatus)(ph, wExpTrgSignal);
    }
    ...
    int PCO_GetFPSExposureMode(HANDLE ph, WORD* wFPSExposureMode, DWORD* dwFPSExposureTime) {
        ...
        return reinterpret_cast<PCO_GetFPSExposureMode_func>(_PCO_GetFPSExposureMode)(ph, wFPSExposureMode, dwFPSExposureTime);
    }
    ...
    int PCO_SetFPSExposureMode(HANDLE ph, WORD wFPSExposureMode, DWORD* dwFPSExposureTime) {
        ...
        return reinterpret_cast<PCO_SetFPSExposureMode_func>(_PCO_SetFPSExposureMode)(ph, wFPSExposureMode, dwFPSExposureTime);
    }
    ...
    int PCO_GetModulationMode(HANDLE ph, WORD* wModulationMode, DWORD* dwPeriodicalTime, WORD* wTimebasePeriodical, DWORD* dwNumberOfExposures, LONG* lMonitorOffset) {
        ...
        return reinterpret_cast<PCO_GetModulationMode_func>(_PCO_GetModulationMode)(ph, wModulationMode, dwPeriodicalTime, wTimebasePeriodical, dwNumberOfExposures, lMonitorOffset);
    }
    ...
    int PCO_SetModulationMode(HANDLE ph, WORD wModulationMode, DWORD dwPeriodicalTime, WORD wTimebasePeriodical, DWORD dwNumberOfExposures, LONG lMonitorOffset) {
        ...
        return reinterpret_cast<PCO_SetModulationMode_func>(_PCO_SetModulationMode)(ph, wModulationMode, dwPeriodicalTime, wTimebasePeriodical, dwNumberOfExposures, lMonitorOffset);
    }
    ...
    int PCO_GetFrameRate(HANDLE ph, WORD* wFrameRateStatus, DWORD* dwFrameRate, DWORD* dwFrameRateExposure) {
        ...
        return reinterpret_cast<PCO_GetFrameRate_func>(_PCO_GetFrameRate)(ph, wFrameRateStatus, dwFrameRate, dwFrameRateExposure);
    }
    ...
    int PCO_SetFrameRate(HANDLE ph, WORD* wFrameRateStatus, WORD wFrameRateMode, DWORD* dwFrameRate, DWORD* dwFrameRateExposure) {
        ...
        return reinterpret_cast<PCO_SetFrameRate_func>(_PCO_SetFrameRate)(ph, wFrameRateStatus, wFrameRateMode, dwFrameRate, dwFrameRateExposure);
    }
    ...
    int PCO_GetStorageStruct(HANDLE ph, void* strStorage) {
        ...
        return reinterpret_cast<PCO_GetStorageStruct_func>(_PCO_GetStorageStruct)(ph, strStorage);
    }
    ...
    int PCO_SetStorageStruct(HANDLE ph, void* strStorage) {
        ...
        return reinterpret_cast<PCO_SetStorageStruct_func>(_PCO_SetStorageStruct)(ph, strStorage);
    }
    ...
    int PCO_GetCameraRamSize(HANDLE ph, DWORD* dwRamSize, WORD* wPageSize) {
        ...
        return reinterpret_cast<PCO_GetCameraRamSize_func>(_PCO_GetCameraRamSize)(ph, dwRamSize, wPageSize);
    }
    ...
    int PCO_GetCameraRamSegmentSize(HANDLE ph, DWORD* dwRamSegSize) {
        ...
        return reinterpret_cast<PCO_GetCameraRamSegmentSize_func>(_PCO_GetCameraRamSegmentSize)(ph, dwRamSegSize);
    }
    ...
    int PCO_SetCameraRamSegmentSize(HANDLE ph, DWORD* dwRamSegSize) {
        ...
        return reinterpret_cast<PCO_SetCameraRamSegmentSize_func>(_PCO_SetCameraRamSegmentSize)(ph, dwRamSegSize);
    }
    ...
    int PCO_ClearRamSegment(HANDLE ph) {
        ...
        return reinterpret_cast<PCO_ClearRamSegment_func>(_PCO_ClearRamSegment)(ph);
    }
    ...
    int PCO_GetActiveRamSegment(HANDLE ph, WORD* wActSeg) {
        ...
        return reinterpret_cast<PCO_GetActiveRamSegment_func>(_PCO_GetActiveRamSegment)(ph, wActSeg);
    }
    ...
    int PCO_SetActiveRamSegment(HANDLE ph, WORD wActSeg) {
        ...
        return reinterpret_cast<PCO_SetActiveRamSegment_func>(_PCO_SetActiveRamSegment)(ph, wActSeg);
    }
    ...
    int PCO_GetCompressionMode(HANDLE ph, WORD* wCompressionMode, DWORD* pdwReserved, WORD wReservedLen) {
        ...
        return reinterpret_cast<PCO_GetCompressionMode_func>(_PCO_GetCompressionMode)(ph, wCompressionMode, pdwReserved, wReservedLen);
    }
    ...
    int PCO_SetCompressionMode(HANDLE ph, WORD wCompressionMode, DWORD* pdwReserved, WORD wReservedLen) {
        ...
        return reinterpret_cast<PCO_SetCompressionMode_func>(_PCO_SetCompressionMode)(ph, wCompressionMode, pdwReserved, wReservedLen);
    }
    ...
    int PCO_GetMaxNumberOfImagesInSegment(HANDLE ph, DWORD* dwMaxNumberImages) {
        ...
        return reinterpret_cast<PCO_GetMaxNumberOfImagesInSegment_func>(_PCO_GetMaxNumberOfImagesInSegment)(ph, dwMaxNumberImages);
    }
    ...
    int PCO_GetRecordingStruct(HANDLE ph, void* strRecording) {
        ...
        return reinterpret_cast<PCO_GetRecordingStruct_func>(_PCO_GetRecordingStruct)(ph, strRecording);
    }
    ...
    int PCO_SetRecordingStruct(HANDLE ph, void* strRecording) {
        ...
        return reinterpret_cast<PCO_SetRecordingStruct_func>(_PCO_SetRecordingStruct)(ph, strRecording);
    }
    ...
    int PCO_GetStorageMode(HANDLE ph, WORD* wStorageMode) {
        ...
        return reinterpret_cast<PCO_GetStorageMode_func>(_PCO_GetStorageMode)(ph, wStorageMode);
    }
    ...
    int PCO_GetRecorderSubmode(HANDLE ph, WORD* wRecSubmode) {
        ...
        return reinterpret_cast<PCO_GetRecorderSubmode_func>(_PCO_GetRecorderSubmode)(ph, wRecSubmode);
    }
    ...
    int PCO_SetRecorderSubmode(HANDLE ph, WORD wRecSubmode) {
        ...
        return reinterpret_cast<PCO_SetRecorderSubmode_func>(_PCO_SetRecorderSubmode)(ph, wRecSubmode);
    }
    ...
    int PCO_GetRecordingState(HANDLE ph, WORD* wRecState) {
        ...
        return reinterpret_cast<PCO_GetRecordingState_func>(_PCO_GetRecordingState)(ph, wRecState);
    }
    ...
    int PCO_GetAcquireMode(HANDLE ph, WORD* wAcquMode) {
        ...
        return reinterpret_cast<PCO_GetAcquireMode_func>(_PCO_GetAcquireMode)(ph, wAcquMode);
    }
    ...
    int PCO_SetAcquireMode(HANDLE ph, WORD wAcquMode) {
        ...
        return reinterpret_cast<PCO_SetAcquireMode_func>(_PCO_SetAcquireMode)(ph, wAcquMode);
    }
    ...
    int PCO_GetAcquireModeEx(HANDLE ph, WORD* wAcquMode, DWORD* dwNumberImages, DWORD* dwReserved) {
        ...
        return reinterpret_cast<PCO_GetAcquireModeEx_func>(_PCO_GetAcquireModeEx)(ph, wAcquMode, dwNumberImages, dwReserved);
    }
    ...
    int PCO_GetAcquireControl(HANDLE ph, DWORD* dwAcquCtrlFlags, DWORD* dwReserved, WORD wNumReserved) {
        ...
        return reinterpret_cast<PCO_GetAcquireControl_func>(_PCO_GetAcquireControl)(ph, dwAcquCtrlFlags, dwReserved, wNumReserved);
    }
    ...
    int PCO_GetAcqEnblSignalStatus(HANDLE ph, WORD* wAcquEnableState) {
        ...
        return reinterpret_cast<PCO_GetAcqEnblSignalStatus_func>(_PCO_GetAcqEnblSignalStatus)(ph, wAcquEnableState);
    }
    ...
    int PCO_SetDateTime(HANDLE ph, BYTE ucDay, BYTE ucMonth, WORD wYear, WORD wHour, BYTE ucMin, BYTE ucSec) {
        ...
        return reinterpret_cast<PCO_SetDateTime_func>(_PCO_SetDateTime)(ph, ucDay, ucMonth, wYear, wHour, ucMin, ucSec);
    }
    ...
    int PCO_GetTimestampMode(HANDLE ph, WORD* wTimeStampMode) {
        ...
        return reinterpret_cast<PCO_GetTimestampMode_func>(_PCO_GetTimestampMode)(ph, wTimeStampMode);
    }
    ...
    int PCO_GetRecordStopEvent(HANDLE ph, WORD* wRecordStopEventMode, DWORD* dwRecordStopDelayImages) {
        ...
        return reinterpret_cast<PCO_GetRecordStopEvent_func>(_PCO_GetRecordStopEvent)(ph, wRecordStopEventMode, dwRecordStopDelayImages);
    }
    ...
    int PCO_SetRecordStopEvent(HANDLE ph, WORD wRecordStopEventMode, DWORD dwRecordStopDelayImages) {
        ...
        return reinterpret_cast<PCO_SetRecordStopEvent_func>(_PCO_SetRecordStopEvent)(ph, wRecordStopEventMode, dwRecordStopDelayImages);
    }
    ...
    int PCO_StopRecord(HANDLE ph, WORD* wReserved0, DWORD* dwReserved1) {
        ...
        return reinterpret_cast<PCO_StopRecord_func>(_PCO_StopRecord)(ph, wReserved0, dwReserved1);
    }
    ...
    int PCO_GetImage(HANDLE ph, WORD wSegment, DWORD dw1stImage, DWORD dwLastImage, SHORT sBufNr) {
        ...
        return reinterpret_cast<PCO_GetImage_func>(_PCO_GetImage)(ph, wSegment, dw1stImage, dwLastImage, sBufNr);
    }
    ...
    int PCO_GetImageEx(HANDLE ph, WORD wSegment, DWORD dw1stImage, DWORD dwLastImage, SHORT sBufNr, WORD wXRes, WORD wYRes, WORD wBitPerPixel) {
        ...
        return reinterpret_cast<PCO_GetImageEx_func>(_PCO_GetImageEx)(ph, wSegment, dw1stImage, dwLastImage, sBufNr, wXRes, wYRes, wBitPerPixel);
    }
    ...
    int PCO_GetPendingBuffer(HANDLE ph, int* count) {
        ...
        return reinterpret_cast<PCO_GetPendingBuffer_func>(_PCO_GetPendingBuffer)(ph, count);
    }
    ...
    int PCO_CheckDeviceAvailability(HANDLE ph, WORD wNum) {
        ...
        return reinterpret_cast<PCO_CheckDeviceAvailability_func>(_PCO_CheckDeviceAvailability)(ph, wNum);
    }
    ...
    int PCO_SetTransferParameter(HANDLE ph, void* buffer, int ilen) {
        ...
        return reinterpret_cast<PCO_SetTransferParameter_func>(_PCO_SetTransferParameter)(ph, buffer, ilen);
    }
    ...
    int PCO_GetTransferParameter(HANDLE ph, void* buffer, int ilen) {
        ...
        return reinterpret_cast<PCO_GetTransferParameter_func>(_PCO_GetTransferParameter)(ph, buffer, ilen);
    }
    ...
    int PCO_SetTransferParametersAuto(HANDLE ph, void* buffer, int ilen) {
        ...
        return reinterpret_cast<PCO_SetTransferParametersAuto_func>(_PCO_SetTransferParametersAuto)(ph, buffer, ilen);
    }
    ...
    int PCO_CamLinkSetImageParameters(HANDLE ph, WORD wxres, WORD wyres) {
        ...
        return reinterpret_cast<PCO_CamLinkSetImageParameters_func>(_PCO_CamLinkSetImageParameters)(ph, wxres, wyres);
    }
    ...
    int PCO_SetTimeouts(HANDLE ph, void* buffer, unsigned int size_in) {
        ...
        return reinterpret_cast<PCO_SetTimeouts_func>(_PCO_SetTimeouts)(ph, buffer, size_in);
    }
    ...
    int PCO_GetImageTransferMode(HANDLE ph, void* param, int ilen) {
        ...
        return reinterpret_cast<PCO_GetImageTransferMode_func>(_PCO_GetImageTransferMode)(ph, param, ilen);
    }
    ...
    int PCO_SetImageTransferMode(HANDLE ph, void* param, int ilen) {
        ...
        return reinterpret_cast<PCO_SetImageTransferMode_func>(_PCO_SetImageTransferMode)(ph, param, ilen);
    }
    ...
    int PCO_GetMetaData(HANDLE ph, SHORT sBufNr, void* pMetaData, DWORD dwReserved1, DWORD dwReserved2) {
        ...
        return reinterpret_cast<PCO_GetMetaData_func>(_PCO_GetMetaData)(ph, sBufNr, pMetaData, dwReserved1, dwReserved2);
    }
    ...
    int PCO_GetMetaDataExtern(HANDLE ph, void* pBuf, void* pMetaData, DWORD dwReserved1, DWORD dwReserved2) {
        ...
        return reinterpret_cast<PCO_GetMetaDataExtern_func>(_PCO_GetMetaDataExtern)(ph, pBuf, pMetaData, dwReserved1, dwReserved2);
    }
    ...
    int PCO_GetTimeStamp(HANDLE ph, SHORT sBufNr, WORD* wBuf, void* strTimeStamp) {
        ...
        return reinterpret_cast<PCO_GetTimeStamp_func>(_PCO_GetTimeStamp)(ph, sBufNr, wBuf, strTimeStamp);
    }
    ...
    int PCO_GetDeviceStatus(HANDLE ph, WORD wNum, DWORD* dwStatus, WORD wStatusLen) {
        ...
        return reinterpret_cast<PCO_GetDeviceStatus_func>(_PCO_GetDeviceStatus)(ph, wNum, dwStatus, wStatusLen);
    }
    ...
    int PCO_ControlCommandCall(HANDLE ph, void* buf_in, unsigned int size_in, void* buf_out, unsigned int size_out) {
        ...
        return reinterpret_cast<PCO_ControlCommandCall_func>(_PCO_ControlCommandCall)(ph, buf_in, size_in, buf_out, size_out);
    }
    ...
    int PCO_ResetLib() {
        ...
        return reinterpret_cast<PCO_ResetLib_func>(_PCO_ResetLib)();
    }
    ...
    int PCO_InitializeLib() {
        ...
        return reinterpret_cast<PCO_InitializeLib_func>(_PCO_InitializeLib)();
    }
    ...
    int PCO_CleanupLib() {
        ...
        return reinterpret_cast<PCO_CleanupLib_func>(_PCO_CleanupLib)();
    }
    ...
    int PCO_EnableSoftROI(HANDLE ph, WORD wSoftROIFlags, void* param, int ilen) {
        ...
        return reinterpret_cast<PCO_EnableSoftROI_func>(_PCO_EnableSoftROI)(ph, wSoftROIFlags, param, ilen);
    }
    ...
    int PCO_GetAPIManagement(HANDLE ph, WORD* wFlags, void* pstrApi) {
        ...
        return reinterpret_cast<PCO_GetAPIManagement_func>(_PCO_GetAPIManagement)(ph, wFlags, pstrApi);
    }
    ...
    int PCO_GetVersionInfoSC2_Cam(char* pszName, int iNameLength, char* pszPath, int iPathLength, int* piMajor, int* piMinor, int* piPatch, int* piBuild) {
        ...
        return reinterpret_cast<PCO_GetVersionInfoSC2_Cam_func>(_PCO_GetVersionInfoSC2_Cam)(pszName, iNameLength, pszPath, iPathLength, piMajor, piMinor, piPatch, piBuild);
    }
...
private:
    ...
    void* _PCO_GetTemperature = nullptr;
    void* _PCO_GetInfoString = nullptr;
    void* _PCO_GetCameraName = nullptr;
    void* _PCO_GetFirmwareInfo = nullptr;
    void* _PCO_GetCameraSetup = nullptr;
    void* _PCO_SetCameraSetup = nullptr;
    void* _PCO_RebootCamera = nullptr;
    void* _PCO_GetShutterMode = nullptr;
    ...
    void* _PCO_GetCameraDescriptionEx = nullptr;
    void* _PCO_GetSensorFormat = nullptr;
    void* _PCO_SetSensorFormat = nullptr;
    void* _PCO_GetSizes = nullptr;
    void* _PCO_GetROI = nullptr;
    void* _PCO_SetROI = nullptr;
    void* _PCO_GetBinning = nullptr;
    void* _PCO_SetBinning = nullptr;
    void* _PCO_GetPixelRate = nullptr;
    void* _PCO_SetPixelRate = nullptr;
    void* _PCO_GetConversionFactor = nullptr;
    void* _PCO_SetConversionFactor = nullptr;
    void* _PCO_GetDoubleImageMode = nullptr;
    void* _PCO_SetDoubleImageMode = nullptr;
    void* _PCO_GetADCOperation = nullptr;
    void* _PCO_SetADCOperation = nullptr;
    void* _PCO_GetIRSensitivity = nullptr;
    void* _PCO_SetIRSensitivity = nullptr;
    void* _PCO_GetCoolingSetpoints = nullptr;
    void* _PCO_GetCoolingSetpointTemperature = nullptr;
    void* _PCO_SetCoolingSetpointTemperature = nullptr;
    void* _PCO_GetOffsetMode = nullptr;
    void* _PCO_SetOffsetMode = nullptr;
    void* _PCO_GetNoiseFilterMode = nullptr;
    void* _PCO_SetNoiseFilterMode = nullptr;
    void* _PCO_GetHWIOSignalCount = nullptr;
    void* _PCO_GetHWIOSignalDescriptor = nullptr;
    void* _PCO_GetColorCorrectionMatrix = nullptr;
    void* _PCO_GetDSNUAdjustMode = nullptr;
    void* _PCO_SetDSNUAdjustMode = nullptr;
    void* _PCO_InitDSNUAdjustment = nullptr;
    void* _PCO_GetCDIMode = nullptr;
    void* _PCO_SetCDIMode = nullptr;
    void* _PCO_GetLookupTableInfo = nullptr;
    void* _PCO_GetActiveLookupTable = nullptr;
    void* _PCO_SetActiveLookupTable = nullptr;
    void* _PCO_GetIntensifiedGatingMode = nullptr;
    void* _PCO_SetIntensifiedGatingMode = nullptr;
    void* _PCO_GetIntensifiedMCP = nullptr;
    void* _PCO_SetIntensifiedMCP = nullptr;
    void* _PCO_GetSensorDarkOffset = nullptr;
    void* _PCO_GetTimingStruct = nullptr;
    void* _PCO_SetTimingStruct = nullptr;
    void* _PCO_GetDelayExposureTime = nullptr;
    void* _PCO_SetDelayExposureTime = nullptr;
    void* _PCO_GetDelayExposureTimeTable = nullptr;
    void* _PCO_SetDelayExposureTimeTable = nullptr;
    void* _PCO_GetTriggerMode = nullptr;
    void* _PCO_SetTriggerMode = nullptr;
    void* _PCO_ForceTrigger = nullptr;
    void* _PCO_GetCameraBusyStatus = nullptr;
    void* _PCO_GetPowerDownMode = nullptr;
    void* _PCO_SetPowerDownMode = nullptr;
    void* _PCO_GetUserPowerDownTime = nullptr;
    void* _PCO_SetUserPowerDownTime = nullptr;
    void* _PCO_GetExpTrigSignalStatus = nullptr;
    void* _PCO_GetCOCRuntime = nullptr;
    void* _PCO_GetFPSExposureMode = nullptr;
    void* _PCO_SetFPSExposureMode = nullptr;
    void* _PCO_GetModulationMode = nullptr;
    void* _PCO_SetModulationMode = nullptr;
    void* _PCO_GetFrameRate = nullptr;
    void* _PCO_SetFrameRate = nullptr;
    void* _PCO_GetStorageStruct = nullptr;
    void* _PCO_SetStorageStruct = nullptr;
    void* _PCO_GetCameraRamSize = nullptr;
    void* _PCO_GetCameraRamSegmentSize = nullptr;
    void* _PCO_SetCameraRamSegmentSize = nullptr;
    void* _PCO_ClearRamSegment = nullptr;
    void* _PCO_GetActiveRamSegment = nullptr;
    void* _PCO_SetActiveRamSegment = nullptr;
    void* _PCO_GetCompressionMode = nullptr;
    void* _PCO_SetCompressionMode = nullptr;
    void* _PCO_GetMaxNumberOfImagesInSegment = nullptr;
    void* _PCO_GetRecordingStruct = nullptr;
    void* _PCO_SetRecordingStruct = nullptr;
    void* _PCO_GetStorageMode = nullptr;
    void* _PCO_SetStorageMode = nullptr;
    void* _PCO_GetRecorderSubmode = nullptr;
    void* _PCO_SetRecorderSubmode = nullptr;
    void* _PCO_GetRecordingState = nullptr;
    void* _PCO_SetRecordingState = nullptr;
    void* _PCO_ArmCamera = nullptr;
    void* _PCO_GetAcquireMode = nullptr;
    void* _PCO_SetAcquireMode = nullptr;
    void* _PCO_GetAcquireModeEx = nullptr;
    void* _PCO_SetAcquireModeEx = nullptr;
    void* _PCO_GetAcquireControl = nullptr;
    void* _PCO_SetAcquireControl = nullptr;
    void* _PCO_GetAcqEnblSignalStatus = nullptr;
    void* _PCO_SetDateTime = nullptr;
    void* _PCO_GetTimestampMode = nullptr;
    void* _PCO_SetTimestampMode = nullptr;
    void* _PCO_GetRecordStopEvent = nullptr;
    void* _PCO_SetRecordStopEvent = nullptr;
    void* _PCO_StopRecord = nullptr;
    void* _PCO_GetImage = nullptr;
    void* _PCO_GetImageEx = nullptr;
    void* _PCO_GetPendingBuffer = nullptr;
    void* _PCO_CheckDeviceAvailability = nullptr;
    void* _PCO_SetTransferParameter = nullptr;
    void* _PCO_GetTransferParameter = nullptr;
    void* _PCO_SetTransferParametersAuto = nullptr;
    void* _PCO_CamLinkSetImageParameters = nullptr;
    void* _PCO_SetImageParameters = nullptr;
    void* _PCO_SetTimeouts = nullptr;
    void* _PCO_GetImageTransferMode = nullptr;
    void* _PCO_SetImageTransferMode = nullptr;
    void* _PCO_AddBufferExtern = nullptr;
    void* _PCO_GetMetaData = nullptr;
    void* _PCO_GetMetaDataExtern = nullptr;
    void* _PCO_GetTimeStamp = nullptr;
    void* _PCO_GetDeviceStatus = nullptr;
    void* _PCO_ControlCommandCall = nullptr;
    void* _PCO_ResetLib = nullptr;
    void* _PCO_InitializeLib = nullptr;
    void* _PCO_CleanupLib = nullptr;
    void* _PCO_EnableSoftROI = nullptr;
    void* _PCO_GetAPIManagement = nullptr;
    void* _PCO_GetErrorTextSDK = nullptr;
    void* _PCO_GetVersionInfoSC2_Cam = nullptr;
