...
#pragma message ("If you still need access to the texts please use PCO_errortext.h.")
...
#warning ("If you still need access to the texts please use PCO_errortext.h.")
