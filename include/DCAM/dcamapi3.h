...
#ifdef __MULTIPROCESSING__
typedef	MPEventID	HDCAMSIGNAL;
#else
#ifndef MPEventID	// MACOSX_DEPLOYMENT_TARGET >= "10.8"
typedef	void*		HDCAMSIGNAL;
#else
typedef	MPEventID	HDCAMSIGNAL;
#endif
#endif
...
DCAM_DECLARE_BEGIN( enum, DCAM_DATATYPE )
{
	...
	DCAM_DATATYPE_YUV411		=	0x01000000,	/* bit 24,  8bit, [ u0, y0, y1, v0, y2, y3 ], [u4, y4, y5, v4, v6, y7], */
	DCAM_DATATYPE_YUV422		=	0x02000000,	/* bit 25,  8bit, [ u0, y0, v0, y1 ], [u2, y2, v2, v3 ], */
	DCAM_DATATYPE_YUV444		=	0x04000000, /* bit 26,  8bit, [ u0, y0, v0 ], [ u1, y1, v1 ], */
